...
## Vertexes similar to seesaw I
# hGdGu = lfvhd.VertexHSS(-I*λ1*v)
# Guliνl = lfvhd.VertexSFF(-I*(sqrt(2)/v)*mi*U[i,l],0) #-
# Gdljνl = lfvhd.VertexSFF(0,-I*(sqrt(2)/v)*mj*conjugate(U[j,l]))#-


# hGdWu = lfvhd.VertexHSpVm(I*g/2)#-
# Wdljνl = lfvhd.VertexVFF(0,I*(g/sqrt(2))*conjugate(U[j,l]))#-
# hWdGu = lfvhd.VertexHVpSm(I*g/2)#-
# Wuliνl = lfvhd.VertexVFF(0,I*(g/sqrt(2))*(U[i,l]))#-
