...
C = matrix(
    [[Cij(i,j) for i in range(9)] for j in range(9)]
)
...
def B012_mni2_Cij_sum(a,b):
    return fsum(
    [
        B012_nn[(i-1 ,j-1)]*mn[i-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def B012_mnj2_Cij_sum(a,b):
    return fsum(
    [
        B012_nn[(i-1 ,j-1)]*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def B012_mnimnj_Cijc_sum(a,b):
    return fsum(
    [
        B012_nn[(i-1 ,j-1)]*mn[i-1]*mn[j-1]*conj(C[i-1, j-1])*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C0_mni2Wnn_Cij_sum(a, b):
    return fsum(
    [
        C0_Wnn[i-1,j-1]*mn[i-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C0_mni2Hnn_Cij_sum(a, b):
    return fsum(
    [
        C0_Hnn[i-1,j-1]*mn[i-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C0_mnj2Wnn_Cij_sum(a, b):
    return fsum(
    [
        C0_Wnn[i-1,j-1]*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C0_mnj2Hnn_Cij_sum(a, b):
    return fsum(
    [
        C0_Hnn[i-1,j-1]*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C1_mnj2Wnn_Cij_sum(a, b):
    return fsum(
    [
        C1_Wnn_caso(a)[i-1,j-1]*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C1_mnj2Hnn_Cij_sum(a, b):
    return fsum(
    [
        C1_Hnn_caso(a)[i-1,j-1]*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C1_mni2Wnn_Cij_sum(a, b):
    return fsum(
    [
        C1_Wnn_caso(a)[i-1,j-1]*mn[i-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C1_mni2Hnn_Cij_sum(a, b):
    return fsum(
    [
        C1_Hnn_caso(a)[i-1,j-1]*mn[i-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C1_mni2mnj2Wnn_Cij_sum(a, b):
    return fsum(
    [
        C1_Wnn_caso(a)[i-1,j-1]*mn[i-1]**2*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10)
        for j in range(1, 10) # if i != j
        ]
    )
...
def C1_mni2mnj2Hnn_Cij_sum(a, b):
    return fsum(
    [
        C1_Hnn_caso(a)[i-1,j-1]*mn[i-1]**2*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10)
        for j in range(1, 10) # if i != j
        ]
    )
...
def C1_mnimnjWnn_Cijc_sum(a, b):
    return fsum(
    [
        C1_Wnn_caso(a)[i-1,j-1]*mn[i-1]*mn[j-1]*conj(C[i-1, j-1])*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10)
        for j in range(1, 10) # if i != j
        ]
    )
...
def C1_mnimnjHnn_Cijc_sum(a, b):
    return fsum(
    [
        C1_Hnn_caso(a)[i-1,j-1]*mn[i-1]*mn[j-1]*conj(C[i-1, j-1])*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10)
        for j in range(1, 10) # if i != j
        ]
    )
...
def mni2_mnj2_C1_Wnn_Cijc_sum(a, b):
    return fsum(
    [
        (mn[i-1]**2 + mn[j-1]**2)*C1_Wnn_caso(a)[i-1,j-1]*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10)
        for j in range(1, 10) # if i != j
        ]
    )
...
def C2_mnj2Wnn_Cij_sum(a, b):
    return fsum(
    [
        C2_Wnn_caso(b)[i-1,j-1]*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C2_mnj2Hnn_Cij_sum(a, b):
    return fsum(
    [
        C2_Hnn_caso(b)[i-1,j-1]*mn[j-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C2_mni2Wnn_Cij_sum(a, b):
    return fsum(
    [
        C2_Wnn_caso(b)[i-1,j-1]*mn[i-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
def C2_mni2Hnn_Cij_sum(a, b):
    return fsum(
    [
        C2_Hnn_caso(b)[i-1,j-1]*mn[i-1]**2*C[i-1, j-1]*Unu[b-1,j-1]*Unu_dagger[i-1,a-1] for i in range(1, 10) for j in range(1, 10)
        # if i != j
        ]
    )
...
# B10 matrix niW
B10_nW = lambda a: [
    lfvhd_mp.B1_0(ml[a],mn[i],mW) for i in range(9)
    ]
...
# B10 matrix niH
B10_nH = lambda a: [
    lfvhd_mp.B1_0(ml[a],mn[i],mHpm) for i in range(9)
    ]
...
def B10_nW_mni2_UU_sum(a,b):
    return fsum(
        [B10_nW_caso(a)[i-1]*mn[i-1]**2*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
        )
...
def B10_nH_mni2_UU_sum(a,b):
    return fsum(
        [B10_nH_caso(a)[i-1]*mn[i-1]**2*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
        )
...
# B20 matrix niW
B20_nW = lambda b: [
    lfvhd_mp.B1_0(ml[b],mn[i],mW) for i in range(9)
    ]
...
def B20_nW_mni2_UU_sum(a,b):
    return fsum(
        [B20_nW_caso(b)[i-1]*mn[i-1]**2*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
        )
...
# B20 matrix niH
B20_nH = lambda b: [
    lfvhd_mp.B1_0(ml[b],mn[i],mHpm) for i in range(9)
    ]
...
def B20_nH_mni2_UU_sum(a,b):
    return fsum(
        [B20_nH_caso(b)[i-1]*mn[i-1]**2*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
        )
...
# B11 matrix niW
B11_nW = lambda a: [
    lfvhd_mp.B1_1(ml[a],mn[i],mW) for i in range(9)
    ]
...
# B11 matrix niH
B11_nH = lambda a: [
    lfvhd_mp.B1_1(ml[a],mn[i],mHpm) for i in range(9)
    ]
...
def B11_nW_UU_sum(a,b):
    return fsum(
        [B11_nW_caso(a)[i-1]*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
    )
...
def B11_nH_UU_sum(a,b):
    return fsum(
        [B11_nH_caso(a)[i-1]*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
    )
...
def B11_nW_mni2_UU_sum(a,b):
    return fsum(
        [B11_nW_caso(a)[i-1]*mn[i-1]**2*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
    )
...
def B11_nH_mni2_UU_sum(a,b):
    return fsum(
        [B11_nH_caso(a)[i-1]*mn[i-1]**2*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
    )
...
# B21 matrix niW
B21_nW = lambda b: [
    lfvhd_mp.B2_1(ml[b],mn[i],mW) for i in range(9)
    ]
...
def B21_nW_UU_sum(a,b):
    return fsum(
        [B21_nW_caso(b)[i-1]*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
    )
...
def B21_nW_mni2_UU_sum(a,b):
    return fsum(
        [B21_nW_caso(b)[i-1]*mn[i-1]**2*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
        )
...
# B21 matrix niH
B21_nH = lambda b: [
    lfvhd_mp.B2_1(ml[b],mn[i],mHpm) for i in range(9)
    ]
...
def B21_nH_UU_sum(a,b):
    return fsum(
        [B21_nH_caso(b)[i-1]*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
    )
...
def B21_nH_mni2_UU_sum(a,b):
    return fsum(
        [B21_nH_caso(b)[i-1]*mn[i-1]**2*Unu[b-1,i-1]*Unu_dagger[i-1,a-1] for i in range(1,10)]
        )
...
if __name__ == '__main__':
    ...
    plt.ylabel(r'$\mathcal{BR}(h \to \ell_a \ell_b)$')
